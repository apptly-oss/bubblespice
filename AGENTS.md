...
<!-- cspell:words benchmem covermode deepsource fieldalignment gofmt -->
<!-- cspell:words goimports golangci gopath govet goxtools -->
<!-- cspell:words coverprofile gotest languagetool shellcheck -->
...
The project uses golangci-lint v2.3.0 with full Go 1.24 support.
